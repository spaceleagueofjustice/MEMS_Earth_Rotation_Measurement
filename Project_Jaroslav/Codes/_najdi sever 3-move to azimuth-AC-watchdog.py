...
TESTID = "NAJDI_SEVER_AC"

FIND_NORTH_STEP_DEG  = 10.0
...
# (stejny mechanismus a duvod jako v mereni_AC_fixni_sever.py - viz tam
# pro detailni komentar). Cisty software, motor se timhle nedotyka.
# =============================================================================
...
def main():
    ...
    _gyro_history.clear()  # cista historie pred ostrym merenim
    csv_header_once()
